/* =====================================================================
   three.js GLTFLoader r160 - converted to a classic script
   ---------------------------------------------------------------------
   Source: https://cdn.jsdelivr.net/npm/three@0.160.0/examples/jsm/loaders/GLTFLoader.js
   Licence: MIT (three.js authors)
   Downloaded 2026-09-08, 108,522 bytes.

   Why converted: the upstream file is an ES module that does
   `import {...} from 'three'`. Math Dungeon loads three.min.js as a plain
   global script and is opened straight off disk, where ES module imports
   are blocked by CORS. So the import block becomes a destructure off the
   global THREE, the exports are attached to THREE, and the single helper
   it pulls from BufferGeometryUtils (toTrianglesDrawMode) is inlined.
   No functional edits beyond that.
   ===================================================================== */
(function () {
"use strict";
if (typeof THREE === "undefined") { console.error("GLTFLoader: THREE not loaded"); return; }
